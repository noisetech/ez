			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<?php if (
						...
						<li><a href="<?= site_url('dashboard') ?>"><i class="fa fa-arrow-right"></i> <span>Dashboard</span></a>
						</li>
					<?php	} ?>
					...
					<?php if (
						...
						<li><a href="<?= site_url('/user') ?>"><i class="fa fa-arrow-right"></i> <span>Users</span></a></li>
					<?php	} ?>
